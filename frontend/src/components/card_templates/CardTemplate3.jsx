  ...
  <Row xs={1} md={2} className="g-4">
    {allCards.map((cards) => (
      ...
      <Card className="card-styling " style={{textAlign:"left", width:"70rem", margin:"20px", backgroundColor:"grey", flexDirection:"row"}}key ={cards._id}>
              ...
              <Col>
                <div className="justify-content-center align-items-right" style={{marginRight:"-20px", marginTop:"40px", marginBottom:"40px"}}>
                
                <Card.Img src={cards.cardImagePath} alt="Card image"style={{height: "500px", width:"540px"}}/>
                </div>
              </Col>
